...
This is also called conservative regridding and is computationally the most demanding but also most preserving approach. It works much like the weighted overlay method
...
Consideration: ideally, many data sources will be collected already into a DGGS. regridding large amounts of data for now creates duplicates.
